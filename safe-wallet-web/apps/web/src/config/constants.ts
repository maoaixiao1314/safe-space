...
// For Hetu: Testnet = 565000, Mainnet = 560000
export const DEFAULT_TESTNET_CHAIN_ID = +(process.env.NEXT_PUBLIC_DEFAULT_TESTNET_CHAIN_ID ?? 565000)
export const DEFAULT_MAINNET_CHAIN_ID = +(process.env.NEXT_PUBLIC_DEFAULT_MAINNET_CHAIN_ID ?? 560000)
...
console.log('🔧 DEFAULT_CHAIN_ID selected:', DEFAULT_CHAIN_ID, 'based on IS_PRODUCTION:', IS_PRODUCTION)
